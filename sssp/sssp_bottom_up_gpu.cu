...
const int V = 218;
const char file_result[] = "/home/yuede/small_graph/dataset_sssp/sssp_bottom_up_gpu.result";
...
void bfs_sa(int root, graph *g)
{
    ...
    traverse_one<<<1, V>>>(dev_beg_pos, dev_csr, dev_weight, dev_sa_global, dev_flag_traverse);
